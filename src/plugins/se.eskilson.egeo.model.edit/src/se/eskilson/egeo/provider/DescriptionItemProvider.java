...
/**
 * This is the item provider adapter for a {@link se.eskilson.egeo.Description} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DescriptionItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_Description_text_feature",
								"_UI_Description_type"),
						EgeoPackage.Literals.DESCRIPTION__TEXT, true, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_Description_html_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_Description_html_feature",
								"_UI_Description_type"),
						EgeoPackage.Literals.DESCRIPTION__HTML, true, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Description"));
	}
	...
	public String getText(Object object) {
		String label = ((Description) object).getText();
