...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>egeo</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EgeoExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(EgeoPackage.eNS_URI,
				EgeoPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.egeo"));
				CacheDB root = EgeoFactory.eINSTANCE.createCacheDB();
