...
/**
 * This is the item provider adapter for a {@link egeo.Description} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         getString("_UI_PropertyDescriptor_description", "_UI_Description_html_feature", "_UI_Description_type"),
         EgeoPackage.Literals.DESCRIPTION__HTML,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EgeoPackage.Literals.DESCRIPTION__TEXT,
         true,
         false,
         false,
  ...
  public String getText(Object object)
  {
    ...
    return getString("_UI_Description_type") + " " + description.isHtml();
  }
