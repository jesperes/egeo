...
/**
 * This is the item provider adapter for a {@link egeo.Coordinate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Coordinate_lat_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Coordinate_lat_feature", "_UI_Coordinate_type"),
         EgeoPackage.Literals.COORDINATE__LAT,
         true,
         false,
         false,
  ...
  protected void addLonPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Coordinate_lon_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Coordinate_lon_feature", "_UI_Coordinate_type"),
         EgeoPackage.Literals.COORDINATE__LON,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  {
    BigDecimal labelValue = ((Coordinate)object).getLat();
    String label = labelValue == null ? null : labelValue.toString();
    return label == null || label.length() == 0 ?
      getString("_UI_Coordinate_type") :
      getString("_UI_Coordinate_type") + " " + label;
  }
