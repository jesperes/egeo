...
/**
 * This is the item provider adapter for a {@link egeo.gpx.groundspeak.AttributeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GroundspeakPackage.Literals.ATTRIBUTE_TYPE__VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GroundspeakPackage.Literals.ATTRIBUTE_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIncPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AttributeType_inc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AttributeType_inc_feature", "_UI_AttributeType_type"),
				 GroundspeakPackage.Literals.ATTRIBUTE_TYPE__INC,
				 true,
				 false,
				 false,
