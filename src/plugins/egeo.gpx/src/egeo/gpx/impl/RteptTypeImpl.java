 ...
 * <ul>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getEle <em>Ele</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getMagvar <em>Magvar</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getGeoidheight <em>Geoidheight</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getCmt <em>Cmt</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getSrc <em>Src</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getUrlname <em>Urlname</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getSym <em>Sym</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getFix <em>Fix</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getSat <em>Sat</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getHdop <em>Hdop</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getVdop <em>Vdop</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getPdop <em>Pdop</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getAgeofdgpsdata <em>Ageofdgpsdata</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getDgpsid <em>Dgpsid</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getLat <em>Lat</em>}</li>
 *   <li>{@link egeo.gpx.impl.RteptTypeImpl#getLon <em>Lon</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RteptTypeImpl extends MinimalEObjectImpl.Container implements RteptType {
	...
	protected EClass eStaticClass() {
		return GpxPackage.Literals.RTEPT_TYPE;
	}
	...
	public void setEle(BigDecimal newEle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__ELE, oldEle, ele));
	}
	...
	public void setTime(XMLGregorianCalendar newTime) {
		...
		time = newTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__TIME, oldTime, time));
	}
	...
	public void setMagvar(BigDecimal newMagvar) {
		...
		magvar = newMagvar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__MAGVAR, oldMagvar, magvar));
	}
	...
	public void setGeoidheight(BigDecimal newGeoidheight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__GEOIDHEIGHT, oldGeoidheight, geoidheight));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__NAME, oldName, name));
	}
	...
	public void setCmt(String newCmt) {
		...
		cmt = newCmt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__CMT, oldCmt, cmt));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__DESC, oldDesc, desc));
	}
	...
	public void setSrc(String newSrc) {
		...
		src = newSrc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__SRC, oldSrc, src));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__URL, oldUrl, url));
	}
	...
	public void setUrlname(String newUrlname) {
		...
		urlname = newUrlname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__URLNAME, oldUrlname, urlname));
	}
	...
	public void setSym(String newSym) {
		...
		sym = newSym;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__SYM, oldSym, sym));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__TYPE, oldType, type));
	}
	...
	public void setFix(FixType newFix) {
		...
		fixESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__FIX, oldFix, fix, !oldFixESet));
	}
	...
	public void unsetFix() {
		...
		fixESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GpxPackage.RTEPT_TYPE__FIX, oldFix, FIX_EDEFAULT, oldFixESet));
	}
	...
	public void setSat(BigInteger newSat) {
		...
		sat = newSat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__SAT, oldSat, sat));
	}
	...
	public void setHdop(BigDecimal newHdop) {
		...
		hdop = newHdop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__HDOP, oldHdop, hdop));
	}
	...
	public void setVdop(BigDecimal newVdop) {
		...
		vdop = newVdop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__VDOP, oldVdop, vdop));
	}
	...
	public void setPdop(BigDecimal newPdop) {
		...
		pdop = newPdop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__PDOP, oldPdop, pdop));
	}
	...
	public void setAgeofdgpsdata(BigDecimal newAgeofdgpsdata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__AGEOFDGPSDATA, oldAgeofdgpsdata, ageofdgpsdata));
	}
	...
	public void setDgpsid(BigInteger newDgpsid) {
		...
		dgpsid = newDgpsid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__DGPSID, oldDgpsid, dgpsid));
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, GpxPackage.RTEPT_TYPE__ANY);
		}
		return any;
	}
	...
	public void setLat(BigDecimal newLat) {
		...
		lat = newLat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__LAT, oldLat, lat));
	}
	...
	public void setLon(BigDecimal newLon) {
		...
		lon = newLon;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpxPackage.RTEPT_TYPE__LON, oldLon, lon));
	}
