...
public class LogImpl extends MinimalEObjectImpl.Container implements Log {
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.LOG__TEXT, oldText, text));
	}
			...
			if (user != oldUser) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EgeoPackage.LOG__USER, oldUser, user));
			}
		}
		return user;
	}
	...
	public void setEncoded(boolean newEncoded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.LOG__ENCODED, oldEncoded, encoded));
	}
	...
	public void setLogId(int newLogId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.LOG__LOG_ID, oldLogId, logId));
	}
	...
	public void setDate(Date newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.LOG__DATE, oldDate, date));
	}
	...
	public void setLogType(LogType newLogType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.LOG__LOG_TYPE, oldLogType, logType));
	}
