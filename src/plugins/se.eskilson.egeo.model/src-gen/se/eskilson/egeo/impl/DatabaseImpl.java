...
public class DatabaseImpl extends MinimalEObjectImpl.Container implements Database
{
  ...
  public EList<Cache> getCaches()
  {
    if (caches == null)
    {
      caches = new EObjectContainmentEList<Cache>(Cache.class, this, EgeoPackage.DATABASE__CACHES);
    }
    return caches;
  }
  ...
  public EList<Attribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, EgeoPackage.DATABASE__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public EList<User> getUsers()
  {
    if (users == null)
    {
      users = new EObjectContainmentEList<User>(User.class, this, EgeoPackage.DATABASE__USERS);
    }
    return users;
  }
