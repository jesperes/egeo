...
public class CoordinateImpl extends MinimalEObjectImpl.Container implements Coordinate
{
  ...
  public void setLatitude(double newLatitude)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EgeoPackage.COORDINATE__LATITUDE, oldLatitude, latitude));
  }
  ...
  public void setLongitude(double newLongitude)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EgeoPackage.COORDINATE__LONGITUDE, oldLongitude, longitude));
  }
