...
public class CacheImpl extends MinimalEObjectImpl.Container implements Cache {
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__CODE, oldCode, code));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setTime(Date newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__TIME, oldTime, time));
	}
	...
	public void setCacheType(CacheType newCacheType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__CACHE_TYPE, oldCacheType, cacheType));
	}
			...
			if (ownedBy != oldOwnedBy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EgeoPackage.CACHE__OWNED_BY, oldOwnedBy, ownedBy));
			}
		}
		return ownedBy;
	}
	...
	public void setCont(se.eskilson.egeo.Container newCont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__CONT, oldCont, cont));
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectResolvingEList<Attribute>(Attribute.class,
					this, EgeoPackage.CACHE__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public void setDifficulty(int newDifficulty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__DIFFICULTY, oldDifficulty, difficulty));
	}
	...
	public void setTerrain(int newTerrain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__TERRAIN, oldTerrain, terrain));
	}
	...
	public void setCountry(String newCountry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__COUNTRY, oldCountry, country));
	}
	...
	public void setState(String newState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__STATE, oldState, state));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetShortDescription(
			Description newShortDescription, NotificationChain msgs) {
		Description oldShortDescription = shortDescription;
		shortDescription = newShortDescription;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, EgeoPackage.CACHE__SHORT_DESCRIPTION,
					oldShortDescription, newShortDescription);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setShortDescription(Description newShortDescription) {
		if (newShortDescription != shortDescription) {
			...
			if (shortDescription != null)
				msgs = ((InternalEObject) shortDescription).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- EgeoPackage.CACHE__SHORT_DESCRIPTION, null,
						msgs);
			if (newShortDescription != null)
				msgs = ((InternalEObject) newShortDescription).eInverseAdd(
						this, EOPPOSITE_FEATURE_BASE
								- EgeoPackage.CACHE__SHORT_DESCRIPTION, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__SHORT_DESCRIPTION, newShortDescription,
					newShortDescription));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLongDescription(
			Description newLongDescription, NotificationChain msgs) {
		Description oldLongDescription = longDescription;
		longDescription = newLongDescription;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, EgeoPackage.CACHE__LONG_DESCRIPTION,
					oldLongDescription, newLongDescription);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setLongDescription(Description newLongDescription) {
		if (newLongDescription != longDescription) {
			...
			if (longDescription != null)
				msgs = ((InternalEObject) longDescription).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- EgeoPackage.CACHE__LONG_DESCRIPTION, null,
						msgs);
			if (newLongDescription != null)
				msgs = ((InternalEObject) newLongDescription).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- EgeoPackage.CACHE__LONG_DESCRIPTION, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__LONG_DESCRIPTION, newLongDescription,
					newLongDescription));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCoordinate(Coordinate newCoordinate,
			NotificationChain msgs) {
		Coordinate oldCoordinate = coordinate;
		coordinate = newCoordinate;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, EgeoPackage.CACHE__COORDINATE,
	...
	public void setCoordinate(Coordinate newCoordinate) {
		if (newCoordinate != coordinate) {
			NotificationChain msgs = null;
			if (coordinate != null)
				msgs = ((InternalEObject) coordinate).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EgeoPackage.CACHE__COORDINATE,
						null, msgs);
			if (newCoordinate != null)
				msgs = ((InternalEObject) newCoordinate).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - EgeoPackage.CACHE__COORDINATE,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__COORDINATE, newCoordinate, newCoordinate));
	}
	...
	public void setHint(String newHint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EgeoPackage.CACHE__HINT, oldHint, hint));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case EgeoPackage.CACHE__HINT:
			return HINT_EDEFAULT == null ? hint != null : !HINT_EDEFAULT
					.equals(hint);
		}
