 ...
 * <ul>
 *   <li>{@link egeo.impl.DescriptionImpl#isHtml <em>Html</em>}</li>
 *   <li>{@link egeo.impl.DescriptionImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DescriptionImpl extends MinimalEObjectImpl.Container implements Description
{
  ...
  public void setHtml(boolean newHtml)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EgeoPackage.DESCRIPTION__HTML, oldHtml, html));
  }
  ...
  public void setText(String newText)
  {
    ...
    text = newText;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EgeoPackage.DESCRIPTION__TEXT, oldText, text));
  }
